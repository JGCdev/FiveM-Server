...
m.messages = {   
    '^1Normas y comandos básicos en discord: https://discord.gg/xMF3raA - Comienzo beta oficial + WIPE 12/07/2019 - Vehículo exclusivo para los veteranos - Oposiciones abiertas',
}
