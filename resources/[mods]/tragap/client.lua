...
function SlotMenu()
  ClearMenu()
  Menu.addTitle("Tragaperras")
  Menu.addButton("~h~Girar","Spin",nil)
...
Citizen.CreateThread(function()
  for k,v in ipairs(moneymachine_slot)do
    ...
    AddTextComponentString("Tragaperras")
...
Citizen.CreateThread(function()
    ...
    if not Menu.hidden then
    	...
    	drawText(0.55,  0.42+0.5, 1.0,1.0,0.6, '~g~' .. tostring(money) .. ' EUR~w~',255,0,0,255,7)
    end
    Menu.renderGUI()
  end
			end
