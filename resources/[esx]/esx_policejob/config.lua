...
Config.AuthorizedWeapons = {
	...
	chef = {
		{ weapon = 'WEAPON_COMBATPISTOL', components = { 0, 0, 1000, 4000, nil }, price = 0 },
		{ weapon = 'WEAPON_ASSAULTSHOTGUN', components = { 0, 6000, 1000, 4000, 8000, nil }, price = 0 },
		{ weapon = 'WEAPON_PUMPSHOTGUN', components = { 2000, 6000, nil }, price = 0 },
		{ weapon = 'WEAPON_NIGHTSTICK', price = 0 },
		{ weapon = 'WEAPON_STUNGUN', price = 0 },
		{ weapon = 'WEAPON_FLASHLIGHT', price = 0 }
...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'pbus', label = 'Bus de prisión', price = 10 },
		{ model = 'riot', label = 'GEOS', price = 10 },
		--{ model = 'police3', label = 'Policía persecución', price = 10 },
		--{ model = 'policet', label = 'Policía de transporte', price = 10 },
		{ model = 'police', label = 'Patrulla', price = 10 },
		{ model = 'policeb', label = 'Moto Policial', price = 10 }
		
	},

	recruit = {
		{ model = '2015polstang', label = 'Deportivo', price = 10 }
	},
	...
	chef = {
		{ model = '2015polstang', label = 'Deportivo', price = 10 },
		{ model = 'fbi2', label = 'FBI SUV', price = 10 }
	},
