Locales['es'] = {
  ...
  ['not_enough_money'] = 'no tienes dinero para la mejora!',
  ['purchased'] = 'has comprado una mejora!',
  ['press_custom'] = 'pulsa ~INPUT_PICKUP~ para ~y~personalizar~s~ vehículo.',
  ['level'] = 'nivel %s',
  ['neon'] = 'neon',
  ['blip_name'] = 'Tuning',
-- Paint Colors
...
-- Cosmetics
  ...
  ['modplateholder'] = 'matrícula - atrás',
  ['modvanityplate'] = 'matrícula - delante',
  ['interior'] = 'interior',
  ['trim'] = 'trim',
  ['dashboard'] = 'dashboard',
