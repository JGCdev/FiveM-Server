Locales['es'] = {
	...
	['press_collect_morf'] = "Presiona ~INPUT_CONTEXT~ para recoger morfina",
	['press_process_morf'] = "Presiona ~INPUT_CONTEXT~ para tratar morfina",
	['press_sell_morf'] = "Presiona ~INPUT_CONTEXT~ para vender la morfina",
