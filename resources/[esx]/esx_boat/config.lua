...
Config.Vehicles = {
	{model = 'seashark', label = 'Moto de agua (color aleatorio)', price = 17500},
	{model = 'seashark3', label = 'Moto de agua Azul Oscuro', price = 17500},
	{model = 'suntrap', label = 'Lancha de recreo', price = 35000},
	{model = 'jetmax', label = 'Lancha veloz', price = 49500},
	{model = 'tropic2', label = 'Tropico', price = 65000},
	{model = 'dinghy2', label = 'Dinghy (Negro)', price = 32500},
	{model = 'dinghy', label = 'Dinghy (Color aleatorio)', price = 40000},
	{model = 'speeder', label = 'Lancha de recreo', price = 85000},
	{model = 'squalo', label = 'Squalo (Color aleatorio)', price = 61000},
	{model = 'toro', label = 'Lampadati', price = 200000},
	{model = 'marquis', label = 'Velero Deluxe', price = 200000},
	{model = 'submersible', label = 'Sumergible', price = 750000}
}