...
AddEventHandler('thiefInProgress', function(street1, street2, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículos ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículos ~w~"..veh.." ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
	end
end)
...
AddEventHandler('thiefInProgressS1', function(street1, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículos por ~w~"..sex.." ~r~en ~w~"..street1)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículo ~w~"..veh.." ~r~por ~w~"..sex.." ~r~en ~w~"..street1)
	end
end)
...
AddEventHandler('thiefInProgressPolice', function(street1, street2, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículo de POLICÍA ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículo de POLICÍA ~w~"..veh.." ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
	end
end)
...
AddEventHandler('thiefInProgressS1Police', function(street1, veh, sex)
	if veh == "NULL" then
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículo de POLICÍA por ~r~en ~w~"..street1)
	else
		TriggerClientEvent("outlawNotify", -1, "~r~Robo de vehículo de POLICÍA ~w~"..veh.." ~r~por ~w~"..sex.." ~r~en ~w~"..street1)
	end
end)

RegisterServerEvent('meleeInProgress')
AddEventHandler('meleeInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Estalló una pelea entre ~w~"..street1.."~r~ y ~w~"..street2)
end)

RegisterServerEvent('meleeInProgressS1')
AddEventHandler('meleeInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Estalló una pelea en ~w~"..street1)
end)


RegisterServerEvent('gunshotInProgress')
AddEventHandler('gunshotInProgress', function(street1, street2, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Disparos ~r~entre ~w~"..street1.."~r~ y ~w~"..street2)
end)

RegisterServerEvent('gunshotInProgressS1')
AddEventHandler('gunshotInProgressS1', function(street1, sex)
	TriggerClientEvent("outlawNotify", -1, "~r~Disparos ~r~en ~w~"..street1)
end)
