...
Config.Animations = {

	{
		...
		items = {
			...
			{label = "Músico", type = "scenario", data = {anim = "WORLD_HUMAN_MUSICIAN"}},
...

	{
		...
		items = {
			...
			{label = "Apretón 1", type = "anim", data = {lib = "mp_common", anim = "givetake1_a"}},
			{label = "Apretón 2", type = "anim", data = {lib = "mp_ped_interaction", anim = "handshake_guy_a"}},
