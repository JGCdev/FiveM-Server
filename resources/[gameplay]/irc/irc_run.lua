...
AddEventHandler('playerActivated', function()
	client:SendMessage('* ' .. GetPlayerName(source) .. '(' .. GetPlayerGuid(source) .. '@' .. GetPlayerEP(source) .. ') ha entrado', '#fourdeltaone')
...
AddEventHandler('playerDropped', function()
	...
	for index,guid in pairs(activatedPlayers) do
		if guid == playerGuid then
			...
			client:SendMessage('* ' .. GetPlayerName(source) .. '(' .. GetPlayerGuid(source) .. '@' .. GetPlayerEP(source) .. ') ha salido', '#fourdeltaone')
